...
<ul class="tabbtn" id="fadetab">
    ...
    -->
        <li class="current"><a href="#">小学（<span><?php echo ($primaryCount); ?></span>）</a></li>
        <li><a href="/backup/wxtest/Home/Manage/pub_junior_index">初中（<span><?php echo ($juniorCount); ?></span>）</a></li>
        <li><a href="/backup/wxtest/Home/Manage/pub_senior_index">高中（<span><?php echo ($seniorCount); ?></span>）</a></li>   
        <li><a href="/backup/wxtest/Home/Manage/pub_kinder_index">幼儿园（<span><?php echo ($kinderCount); ?></span>）</a></li>     
        <li><a href="/backup/wxtest/Home/Manage/pub_kindersmall_index">幼小（<span><?php echo ($kindersmallCount); ?></span>）</a></li>     
        <li><a href="/backup/wxtest/Home/Manage/pub_small_index">小初（<span><?php echo ($smallCount); ?></span>）</a></li>      
        <li><a href="/backup/wxtest/Home/Manage/pub_high_index">初高（<span><?php echo ($highCount); ?></span>）</a></li>   
        <li><a href="/backup/wxtest/Home/Manage/pub_kinders_index">幼小初（<span><?php echo ($kindersCount); ?></span>）</a></li> 
        <li><a href="/backup/wxtest/Home/Manage/pub_system_index">小初高（<span><?php echo ($systemCount); ?></span>）</a></li>  
        <li><a href="/backup/wxtest/Home/Manage/pub_list">全部（<span><?php echo ($allCount); ?></span>）</a></li>
        <li><a href="/backup/wxtest/Home/Manage/pub_group_index">待分组（<span><?php echo ($groupCount); ?></span>）</a></li>  
    <!--
 ...
 **/
    ...
    function pubQueryByCondition(){
       ...
       // var materName= $("[name=materName]").val();
        ...
        $.get("/backup/wxtest/Home/Manage/pub_query/city/" + city + "/area/" + area + "/materName/" + materName + "/gid/" + gid + "/verify/" + verify, null, function(html)
        {
            $("#u40").empty().html(html);
        });        
