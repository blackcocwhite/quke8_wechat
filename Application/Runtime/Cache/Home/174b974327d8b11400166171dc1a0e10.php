...
<ul class="tabbtn" id="fadetab">
    <li><a href="/backup/wxtest/Home/DataStatistics/index">订阅号统计</a></li>
    <li class="current"><a href="#">素材阅读统计</a></li>
...
<script>
    ...
    function indexTwo(id){    //user函数名 一定要和action中的第三个参数一致上面有
        var id = id;         
           $.get('/backup/wxtest/Home/DataStatistics/indexTwo', {'p':id,'sj':$('#date').val(),'gz':$('#gz').val()}, function(data){  //用get方法发送信息到UserAction中的user方法
    ...
    {	
    	 ...
    	 $.ajaxFileUpload({    	   	
             ...
             success: function (data)
             {
          	   ...
          	   window.location.href="/backup/wxtest/Home/DataStatistics/indexTwo";
             }
	     	}); 
    ...
    function daoChu(dao)
    {
    	 ...
    	 var gz=$('#gz').val();
    		...
    		if(gz=='')
			  ...
			  dao.href="/backup/wxtest/Home/DataStatistics/index/csv/1/tm/"+time+"/gz/"+gz; 
...
{	
				$.ajax({
			        type: "GET",
			        url: "/backup/wxtest/Home/DataStatistics/indexTwo",
