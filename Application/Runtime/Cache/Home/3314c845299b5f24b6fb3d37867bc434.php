...
<style type="text/css">
    *{margin:0;padding:0;list-style-type:none;}
	...
	.search-1{ float:left; width:60%; height:30px; line-height:30px; margin:3px auto;}
...
<div class="header">
	...
	<div class="content-1">
    <iframe id="main" name="main" style="width: 100%; HEIGHT: 100%" src="<?php echo U('Menu/wenZhang');?>" frameborder="0" cyberarticle_ext_name="Frame_1"></iframe>
	</div>
